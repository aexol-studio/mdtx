...
export const UserInfo = (commands: commandsType): ICommand => {
    return commands.group([], {
        ...
        render: () => {
            ...
            return (
                <div ref={ref} onClick={handleMenu} className="z-[100] relative py-[0.8rem] bg-transparent mx-[1.6rem]">
                    <div className="px-[3.2rem] cursor-pointer flex gap-[0.8rem] items-center">
                        <p className="text-[1.6rem] leading-[1.8rem] font-[400] text-editor-light1">Menu</p>
                        {/* <Image
              loader={({ src }) => src}
              priority
              width={24}
